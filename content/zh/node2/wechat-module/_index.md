...
微信模块支持枫叶HD系列摄像机，还支持onvif协议的第三方摄像机。目前一个模块最多支持4路摄像机，如果要扩展，需要添加微信模块，如：需要添加11路摄像机，则需3个微信模块，多个微信模块的设置在下面的内容中专门会讲。打开页面左侧**设备列表**菜单，按照下图的步骤：
...
每一个防区都可以绑定一个摄像机，以实现报警视频推送至微信端，方法如图：
