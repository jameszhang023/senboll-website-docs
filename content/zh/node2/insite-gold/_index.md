...
步骤一：确保计算机和网络模块在同一网段下，启动枫叶搜索工具（请访问[资料服务器（账户和密码咨询设备提供商）](https://support.senboll.com)下载），查询网络模块IP地址，双击搜到的模块会弹出网页登录界面，输入用户密码将会进入网页设置界面，如图：
...
2. 代付，如果没有跨境⽀付渠道，访问[枫叶APP缴费](https://support.senboll.com/swan)。
