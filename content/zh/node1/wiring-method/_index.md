...
{{< tip >}}
针对于枫叶总线我们建议采用带屏蔽RVVP4 x 0.75+ 线材，干接点通信方式的线材建议RVV4 x 0.75+，其中“+”表示不低于这个规格，可以比这个规格更高。
...
| 名称 | 通信方式和线材 |
|---|---|
| 操作键盘</br>探测器（总线通信）</br>无线功能扩展模块</br>门禁模块</br>集成打印模块</br>防区模块</br>继电器模块</br>电源模块-PS25/PS45 | 枫叶总线；</br>4芯带屏蔽，</br>规格：RVVP4 x 0.75+ |
| 探测器（干接点通信） | 干接点；</br>4芯，</br>规格：RVV4 x 0.75+ |
| 警号 | 有源方式；</br>2芯，</br>规格：RVVP2 x 1.0+ |
